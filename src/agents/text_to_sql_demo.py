...
from agents.sql_agent import SQLAgent, QueryResult
from utils.cost_calculator import estimate_bedrock_cost
...
class TextToSQLDemo:
    ...
    def __init__(self, db_params: Dict[str, str], aws_endpoint: Optional[str] = None):
