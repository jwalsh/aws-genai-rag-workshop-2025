...
#+BEGIN_SRC python :tangle 03_text_to_sql/setup.py
import os
import sys
import json
import logging
...
#+BEGIN_SRC python :tangle 03_text_to_sql/schema_exploration.py
...
#+BEGIN_SRC python :tangle 03_text_to_sql/data_analysis.py
...
#+BEGIN_SRC python :tangle 03_text_to_sql/sql_agent_init.py
...
#+BEGIN_SRC python :tangle 03_text_to_sql/nl_query_testing.py
...
#+BEGIN_SRC python :tangle 03_text_to_sql/security_testing.py
...
#+BEGIN_SRC python :tangle 03_text_to_sql/advanced_patterns.py
...
#+BEGIN_SRC python :tangle 03_text_to_sql/interactive_interface.py
...
#+BEGIN_SRC python :tangle 03_text_to_sql/performance_optimization.py
